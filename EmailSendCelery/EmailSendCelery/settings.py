"""
Django settings for EmailSendCelery project.
...
SECRET_KEY = 'django-insecure-%m))w^2z*@@2su7knq%$_xlpxld97tew8nbtnk=4qv^qacyc^o'
...
ROOT_URLCONF = 'EmailSendCelery.urls'
...
WSGI_APPLICATION = 'EmailSendCelery.wsgi.application'
...
CELERY_BEAT_SCHEDULE = {
    'add-value-by-ten-secconds' : {
        'task' : 'email_app.tasks.task_print_current_time_by_interval', 
